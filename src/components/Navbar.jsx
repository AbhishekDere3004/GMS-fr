...
const Navbar =() => {
  ...
  <header className="sticky inset-0 z-50 border-b border-slate-100 bg-blue-default backdrop-blur-lg">
      <nav className="mx-auto flex max-w-6xl gap-11 px-6 transition-all duration-200 ease-in-out lg:px-12 py-4">
        ...
        <input className="w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="search" placeholder="Search Here
        "/>
